...
- (void)viewDidLoad {
    ...
    share_ = [[GPPShare alloc] initWithClientID:kClientID];
    share_.delegate = self;
    //-----------------------------
//    [SMAppDelegate sharedInstance].share = share_;

    [attachDeepLinkSwitch_ setOn:NO];

    // Set position of the textfeilds according to the sharing style...
    [self layout];
    
    // Insert value in the textfeilds...
...
- (void)viewDidUnload {
//  [SMAppDelegate sharedInstance].share = nil;
  share_.delegate = nil;
  [share_ release];
  share_ = nil;
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    //set the frame If it is an ipad
