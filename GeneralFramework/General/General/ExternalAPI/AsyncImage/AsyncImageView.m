...
- (void)cleanMemory {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:AsyncImageTargetReleased object:nil];
}
- (void)updateQueue
{
    //start connections
...
- (void)loadImageWithURL:(NSURL *)URL target:(id)target action:(SEL)action
                 success:(SuccessImage)sucess
{
    self.successFull = sucess;
